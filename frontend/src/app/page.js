    ...
    return (
        <>
            <div className={styles.container}>
                ...
                <a href="https://selamy.me" target="_blank" rel="noopener noreferrer" className={styles.selamyLink} title="Join SelamY Community!">
                    <Image src="/favicon.svg" alt="SelamY Logo" width={56} height={56} />
                </a>
            </div>
            <Footer />
        </>
